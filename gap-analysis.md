...
- Renderer does not implement any of the test builder or drag-and-drop flows; project import/export and basic presets management are wired, and export utilities exist for CSV/Excel with a basic exports panel and profiles; AI cache clear is available.
